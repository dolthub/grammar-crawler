...
public class EarlyTerminators {
     ...
     */
    public static interface EarlyTerminator {
        /**
    ...
    /**
     * EarlyTerminators.EarlyTerminator implementation for MySQL CREATE TABLE statements. Detects invalid column definitions (e.g. trying
    ...
    public static class MySQLCreateTableEarlyTerminator implements EarlyTerminator {
